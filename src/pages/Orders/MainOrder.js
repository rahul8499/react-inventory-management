...
// post data call
  ...
  "region": {
    ...
    axios.post(`http://localhost:3000/order/create`, postData);  //post method
            ...
            <div style={{ display: 'flex', marginTop: '1vw' }}>
              <div>
                ...
                <div>
                  ...
                  {errors.advance_payment?.type === 'required' && (
                    <span style={{ color: 'red' }}>
                      field required{' '}
                    </span>
                  )}
              ...
              <div style={{ marginLeft: '1vw' }}>
                ...
                <div>
                  <input
                    ...
                    // {...register('advance_balance')}
                    {...register('advance_balance', { required: true })}
                  />
